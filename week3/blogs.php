<?php 
  ...
  ##################################################################################################
  $sql = "select blogs.* , category.title as cat_title , users.name , users.image as user_image from blogs inner join category on blogs.cat_id = category.id    
        ...
        <div class="post">
          ...
          <div class="post-desc">
            ...
            <div class="post-author">
              ...
              </div> <span><?php echo $Raw['name']?></span>
            </div>
          </div>
        </div>
      </div>
